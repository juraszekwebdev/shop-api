...
class EditAddressController extends AbstractController
{
    /**
    ...
    /**
     * @Route("/editUserAddress", methods={"POST"})
     * @param Request $request
     * @param JWTTokenManagerInterface $JWTManager
     * @return JsonResponse
     */
    public function editAddress(Request $request, JWTTokenManagerInterface $JWTManager)
    {
        ...
        $object->setAddress($requestedContent['address']);
